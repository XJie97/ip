...
/**
 * Task list manager.
 * Supported operations: creating, marking, unmarking, deleting tasks, exiting.
 */
public class Tkit {

    /**
     * Main method. reads input from user interface, processes and prints output.
     * Exit on "bye"
     *
     * @param args unused
     */
    ...
    /**
     * Print standard notification on task add.
     *
     * @param t task added
    ...
    /**
     * Print error notification with error message.
     *
    ...
    /**
     * Change index to start from 1 instead of 0 for user friendliness, validate list bounds.
     *
...
/**
 * Enums: used for keyword mapping and parsing.
 */
enum Command {
    BYE("bye"),
    UNKNOWN(""),
    ...
    /**
     * Resolve input command by first keyword.
     *
...
/**
 * Parse input line into: command and remainder strings.
 */
...
/**
 * Task status. Rendering encapsulated for status stateIcon.
 */
enum Status {
    DONE("X"),
    NOT_DONE(" ");
    ...
    /**
     * @return the single-character stateIcon used in list rendering
     */
...
/**
 * Task type: Deadline, has due date.
 */
...
/**
 * Task type: Event, has start and end dates.
 */
...
/**
 * Task types supported by Tkit bot. Encapsulate type tag.
 */
enum TaskType {
    TODO("T"),
    DEADLINE("D"),
...
/**
 * Checked exception for input error.
 */
